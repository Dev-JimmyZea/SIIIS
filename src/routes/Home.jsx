...
const Home = () => {
  ...
  return (
    <div className={"mt-14 bg-white"}>
      <div className="border rounded p-6 h-56 sm:h-64 xl:h-80 2xl:h-96 pb-10">
      ...
      {/* -------------------------------------------------------------------------------------------------------------------- */}
      <section className="pb-20 bg-gray-700 -mt-6 pt-8">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-6 pt-14 border-t"></div>
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
              <div className="text-gray-600 p-3 text-center inline-flex items-center justify-center w-20 h-20 mb-6 shadow-lg rounded-full border-2 border-gray-300">
                <img
